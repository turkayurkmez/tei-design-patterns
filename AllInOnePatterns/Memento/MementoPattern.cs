...
namespace Memento
{
    ...
    //1. Memento: Günlük ya anı defteri anlamında. 
    ...
    //2. Memento'ya kaydedebileceğiniz nesneyi belirleyen arayüz:
    ...
    //nesneleri günlüğe kaydedecek IRestorable concrete sınıfı:
